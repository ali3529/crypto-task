...
import { loginUser, registerUser } from "../utils/ApiCilent";
          ...
          <div class="flex flex-col w-1/3 bg-[#F8F8FB] justify-center items-center rounded-[3rem] ">
            <div class="flex flex-rocolw space-x-7">
              <div class="flex flex-col text-right">
                <p className="font-bold text-2xl"> ثبت حساب کاربری</p>
            ...
            <form onSubmit={formik.handleSubmit} className="w-10/12 mt-8">
              ...
              <div className="w-full flex justify-center mt-8">
                <button
                  type="submit"
                  className="text-white bg-[#0116CB] justify-center flex items-center rounded-xl w-full h-14"
                >
                  {lodaing ? (
                    <svg
              ...
              <div className="flex flex-row space-x-2 mt-6 justify-end w-10/11">
                <Link className="text-[#0116CB]" to="/login">
                  ورود{" "}
                </Link>
                <label>حساب کاربری دارید ؟</label>
              </div>
            </form>
